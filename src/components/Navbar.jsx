...
const Navbar = () => {
  ...
  return (
    <nav className="fixed w-full top-0 z-50">
      <div className="bg-white/90 text-customPurple shadow-lg">
      ...
      >
        ...
        <div className="flex flex-col space-y-3 mt-12">
          ...
          >
            Home
            <span
              className={`absolute left-0 bottom-0 w-[calc(100%-1rem)] h-0.5 bg-customPink transform origin-center transition-transform duration-300 ${
                activeSection === "home" ? "scale-x-100" : "scale-x-0 group-hover:scale-x-100"
              }`}
            ></span>
          </a>
