...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white/95 text-customPurple fixed w-full top-0 z-50 shadow-lg">
      <div className="max-w-7xl mx-auto px-3 sm:px-5 lg:px-6">
        <div className="flex justify-between items-center h-16 sm:h-18">
          <div className="flex items-center p-1 sm:p-2">
            <a href="#home" className="flex items-center">
      ...
      {/* Mobile Menu */}
      <div
        className={`lg:hidden fixed top-0 right-0 w-3/4 h-screen bg-white/70 text-white p-4 transition-transform ${
          isOpen ? "transform translate-x-0" : "transform translate-x-full"
        }`}
      >
        <button
